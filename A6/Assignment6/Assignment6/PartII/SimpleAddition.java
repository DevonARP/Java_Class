...
public class SimpleAddition extends JFrame {
    ...
    public JPanel createContentPane (){
        ...
        addend1Field.getDocument().addDocumentListener(D1); //Will update automatically
        addend2Field.getDocument().addDocumentListener(D1);
        
        addend1Field.addActionListener(A1); //Will need the enter key pressed
        addend2Field.addActionListener(A1);
